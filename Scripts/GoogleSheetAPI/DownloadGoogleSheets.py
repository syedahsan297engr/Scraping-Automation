...
def download_sheet(spreadsheet_id, gid, outDir, sheet_title):
...
spreadsheet_url = "https://docs.google.com/spreadsheets/d/1F1EvbJjUfjcVMuoY00kgkqTYnBfndQGG22kwlzQqv3g/edit?usp=drive_link"
...
if spreadsheet_id:
    ...
    for sheet_title, gid in sheets_metadata:
        download_sheet(spreadsheet_id, gid, outDir, sheet_title)
else:
