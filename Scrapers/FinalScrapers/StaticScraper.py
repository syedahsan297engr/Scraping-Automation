...
# 85
def mailHazardScraper(driver, filePath):
    driver.get("http://ww7.mailhazard.com")  
    time.sleep(3) # for getting content
    input_xpath = '/html/body/div/main/header/h1'
    content = get_element_value(driver, input_xpath)
    save_to_csv(content, "mailhazard.com", filePath)
    return
...
def main():
    ...
    mailHazardScraper(driver, outputFilePath)
